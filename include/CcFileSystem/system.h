...
#include "CcCommon/defines.h"

#include "CcFileSystem/export.h"
...
CCFS_API void sleep (std::size_t msec);
/** Sleeps the given amount of seconds. */
CCFS_API void sleep_sec (float secs);
...
CCFS_API void register_segfault_handler (void);

/** Handles signal SIGSEGV (segmentation fault) printing a stack trace. */
CCFS_API  void signal_segfault_handler (int code);

/** Prints a stack trace. */
CCFS_API void print_stack_trace (void);
